#!/usr/bin/env python3
"""
Demo Nesne Takip Sistemi
Bu versiyon webcam ile çalışır ve test amaçlı kullanılır.
"""
...
class DemoObjectTracker:
    def __init__(self):
        ...
        self.root = ctk.CTk()
        self.root.title("🎯 Demo Nesne Takip Sistemi - Enemy/Friend Detector")
        ...
        self.use_webcam = True  # Webcam kullan
    ...
    def setup_ui(self):
        ...
        • Kırmızı nesneler "ENEMY" olarak tespit edilir
        • Mavi nesneler "FRIEND" olarak tespit edilir
        • Webcam önüne kırmızı veya mavi nesneler koyun
        • Nesneler otomatik olarak kutulara alınır
        """
        ...
        # Nesne sayıları
        objects_frame = ctk.CTkFrame(stats_frame, fg_color="transparent")
        objects_frame.pack(pady=(0, 15))
        
        # Kırmızı nesneler (Enemy)
        enemy_frame = ctk.CTkFrame(objects_frame, fg_color="#440000", corner_radius=10)
        ...
        friend_frame = ctk.CTkFrame(objects_frame, fg_color="#004400", corner_radius=10)
    ...
    def start_video(self):
        ...
        self.status_label.configure(text="🟢 Webcam bağlandı - Nesneler tespit ediliyor...")
    ...
    def stop_video(self):
        ...
        self.stop_button.configure(state="disabled")
        self.status_label.configure(text="⏹️ Webcam durduruldu")
        
        # Canvas'ı temizle
        self.video_canvas.delete("all")
        self.video_canvas.create_text(
            400, 250,
            text="Webcam görüntüsü bekleniyor...",
            fill="#888888",
            font=("Arial", 16)
        )
    ...
    def video_loop(self):
        ...
        try:
            ...
            if not self.cap.isOpened():
                raise Exception("Webcam bulunamadı!")
